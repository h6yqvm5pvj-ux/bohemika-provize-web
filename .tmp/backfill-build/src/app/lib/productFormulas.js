...
exports.SUPPORTED_PRODUCTS = void 0;
exports.calculateNeon = calculateNeon;
exports.calculateFlexi = calculateFlexi;
exports.calculateMaxEfekt = calculateMaxEfekt;
exports.calculatePillowInjury = calculatePillowInjury;
exports.calculateDomex = calculateDomex;
exports.calculateKoopMajetekObcan = calculateKoopMajetekObcan;
exports.calculateMaxdomov = calculateMaxdomov;
exports.calculateCppAuto = calculateCppAuto;
exports.calculateSlaviaAuto = calculateSlaviaAuto;
exports.calculateCppSimplex = calculateCppSimplex;
exports.calculateCppPPRbez = calculateCppPPRbez;
exports.calculateCppPPRs = calculateCppPPRs;
exports.calculateAllianzAuto = calculateAllianzAuto;
exports.calculateCsobAuto = calculateCsobAuto;
exports.calculateUniqaAuto = calculateUniqaAuto;
exports.calculatePillowAuto = calculatePillowAuto;
exports.calculateKooperativaAuto = calculateKooperativaAuto;
exports.calculateZamex = calculateZamex;
exports.calculateCppCestovko = calculateCppCestovko;
exports.calculateAxaCestovko = calculateAxaCestovko;
exports.calculateComfortCCSimple = calculateComfortCCSimple;
exports.calculateComfortCCOneOff = calculateComfortCCOneOff;
exports.calculateComfortCCGradual = calculateComfortCCGradual;
exports.calculateComfortCC = calculateComfortCC;
exports.getCoefficientSummary = getCoefficientSummary;
...
function neonCoefficients(position, mode) {
    if (mode === "accelerated") {
        switch (position) {
            // Poradci 1–10
            case "poradce1":
...
// NEON – veřejná funkce
function calculateNeon(monthly, position, years = 15, mode = "accelerated") {
...
function flexiCoefficients(position, mode) {
    if (mode === "accelerated") {
        switch (position) {
            // Poradci 1–10
            case "poradce1":
...
function calculateFlexi(monthly, position, mode = "accelerated", years = 6) {
...
function maxEfektCoefficients(position, mode) {
    if (mode === "accelerated") {
        switch (position) {
            // Poradci 1–10
            case "poradce1":
...
function calculateMaxEfekt(monthly, years, position, mode = "accelerated") {
...
function pillowInjuryCoefficients(position, mode) {
    if (mode === "accelerated") {
        switch (position) {
            // Poradci 1–10
            case "poradce1":
...
function calculatePillowInjury(monthly, position, mode = "accelerated") {
    const annual = monthly * 12;
...
// ---------- DOMEX ----------
function domexCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.1108;
...
function domexSubsequentCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.0278;
...
function calculateDomex(amount, frequency, position) {
...
function koopMajetekObcanImmediateCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.1108;
...
function koopMajetekObcanSubsequentCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.0277;
...
function calculateKoopMajetekObcan(amount, frequency, position) {
...
// ---------- MAXDOMOV ----------
function maxdomovImmediateCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 11.54;
...
function maxdomovSubsequentCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 3.46;
...
function calculateMaxdomov(amount, frequency, position) {
...
// ---------- ČPP Auto ----------
function cppAutoCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
        case "poradce2":
...
function calculateCppAuto(amount, frequency, position) {
...
// ---------- SLAVIA Auto ----------
function slaviaAutoCoefficient(position) {
    return cppAutoCoefficient(position);
}
function calculateSlaviaAuto(amount, frequency, position) {
...
// ---------- ČPP Simplex ----------
function cppSimplexCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return pct(4.62);
...
function calculateCppSimplex(amount, frequency, position) {
...
function cppPPRbezImmediateCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return pct(10.39);
...
function cppPPRbezSubsequentCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return pct(3.46);
...
function calculateCppPPRbez(amount, frequency, position) {
...
function cppPPRsCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return pct(3.46);
...
function calculateCppPPRs(amount, frequency, position) {
    const coef = cppPPRsCoefficient(position);
    const perPayment = amount * coef;
    const annualTotal = perPayment * periodsPerYear(frequency);
    const items = [{ title: "💼 Okamžitá provize", amount: perPayment }];
...
// ---------- Allianz Auto ----------
function allianzAutoCoefficient(position) {
    return cppAutoCoefficient(position);
}
function calculateAllianzAuto(amount, frequency, position) {
...
// ---------- ČSOB Auto ----------
function csobAutoCoefficient(position) {
    return cppAutoCoefficient(position);
}
function calculateCsobAuto(amount, frequency, position) {
...
// ---------- UNIQA Auto ----------
function uniqaAutoCoefficient(position) {
    return cppAutoCoefficient(position);
}
function calculateUniqaAuto(amount, frequency, position) {
...
// ---------- Pillow Auto ----------
function pillowAutoCoefficient(position) {
    return cppAutoCoefficient(position);
}
function calculatePillowAuto(amount, frequency, position) {
...
// ---------- Kooperativa Auto ----------
function kooperativaAutoCoefficient(position) {
    return cppAutoCoefficient(position);
}
function calculateKooperativaAuto(amount, frequency, position) {
...
// ---------- ČPP ZAMEX ----------
function zamexCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.0346;
...
function calculateZamex(amount, frequency, position) {
...
// ---------- ČPP Cestovko ----------
function cppCestovkoCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.058;
...
function calculateCppCestovko(amount, position) {
...
// ---------- AXA Cestovko ----------
function axaCestovkoCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.0461;
...
function calculateAxaCestovko(amount, position) {
...
// ---------- Comfort Commodity ----------
function comfortCCImmediateCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.1478;
...
function comfortCCSubsequentCoefficient(position) {
    switch (position) {
        // Poradci 1–10
        case "poradce1":
            return 0.0074;
...
function calculateComfortCCSimple(amount, position) {
...
function calculateComfortCCOneOff(fee, payment, position) {
...
function calculateComfortCCGradual(initialFee, payment, position, targetAmount = 0) {
    const kImmediate = comfortCCImmediateCoefficient(position);
    const kSubsequent = comfortCCSubsequentCoefficient(position);
...
function calculateComfortCC({ fee, payment = 0, targetAmount = 0, isSavings = false, isGradualFee = false, position, }) {
    // prázdný vstup → nic
...
function getCoefficientSummary(product, position, mode) {
    if (!product || !position)
        return [];
