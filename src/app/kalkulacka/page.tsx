      ...
      <div className="w-full max-w-3xl space-y-6">
        ...
        <section className="space-y-1">
          ...
          <div className="relative">
            ...
            {productOpen && (
              <div className="absolute z-30 mt-2 w-full rounded-2xl border border-white/15 bg-slate-950/95 backdrop-blur-2xl shadow-[0_20px_80px_rgba(0,0,0,0.9)] max-h-80 overflow-y-auto">
        ...
        <section className="space-y-3">
          ...
          {saveMessage && (
            <p className="text-xs text-slate-300">{saveMessage}</p>
          )}
          ...
          {items.length > 0 && (
            <div className="rounded-2xl border border-emerald-400/40 bg-emerald-950/60 px-4 py-3 space-y-2 backdrop-blur-2xl shadow-[0_18px_60px_rgba(0,0,0,0.9)]">
              {items.map((item, idx) => {
          ...
          {items.length === 0 && !unsupported && amountText === "" && (
            <p className="text-xs text-slate-400">
              Zadej částku a kalkulačka se přepočítá.
            </p>
          )}
        </section>
      </div>
