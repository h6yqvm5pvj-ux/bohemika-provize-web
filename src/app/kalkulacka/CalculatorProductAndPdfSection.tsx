  ...
  return (
    <section>
        ...
        <div className="space-y-1.5">
          ...
          <div>
            <button
              ...
              className="group relative isolate flex min-h-[3.9rem] w-full items-center justify-between overflow-hidden rounded-xl border border-slate-300 bg-[linear-gradient(135deg,#ffffff_0%,#f8fafc_54%,#eef2f7_100%)] px-3 py-2.5 text-sm text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.85)] outline-none transition hover:border-slate-400 focus:border-slate-900 focus:ring-2 focus:ring-slate-900"
            >
              <span
              ...
              <span className="relative z-[1] flex min-w-0 items-center gap-3">
                ...
                <span className="flex min-w-0 flex-col items-start text-left leading-tight">
                  ...
                  <span className="truncate text-sm font-bold">{currentProductLabel}</span>
                </span>
              </span>
              <span className="relative z-[1] ml-3 inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-500 shadow-sm transition group-hover:text-slate-950">
                <ChevronDown
                  size={17}
                  strokeWidth={2.2}
      ...
      {canImportFromPdf && (
        <div className="space-y-1.5">
          <div
            className={`flex min-h-[3.7rem] w-full flex-col items-start justify-between gap-2.5 rounded-xl border-2 border-dashed px-3 py-2.5 transition sm:flex-row sm:items-center ${
              pdfDropActive
          ...
          >
            <div className="flex min-w-0 items-center gap-3 text-sm font-semibold text-slate-900">
              <span className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-slate-50 text-slate-700">
                <UploadCloud size={16} strokeWidth={2.2} aria-hidden="true" />
              </span>
            ...
            <button
              ...
              className="ui-btn-primary ui-focus inline-flex flex-shrink-0 items-center gap-2 rounded-full px-3 py-1.5 text-sm disabled:cursor-not-allowed disabled:opacity-60"
            >
