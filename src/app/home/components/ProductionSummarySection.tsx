...
export function ProductionSummarySection({
  ...
  const compactSummaryCardClass = isLiteUI
    ? "relative h-full overflow-hidden rounded-[24px] border border-slate-800 bg-slate-950 px-5 py-5 text-white transition-[border-color,box-shadow] duration-200 hover:border-slate-600 focus-within:border-slate-600 focus-within:shadow-[0_0_0_1px_rgba(148,163,184,0.22)] sm:px-7 sm:py-6"
    : "relative h-full overflow-hidden rounded-[24px] border border-slate-800 bg-slate-950 px-5 py-5 text-white shadow-[0_18px_34px_rgba(2,6,23,0.34)] transition-[border-color,box-shadow] duration-200 hover:border-slate-600 hover:shadow-[0_22px_42px_rgba(2,6,23,0.44),0_0_0_1px_rgba(148,163,184,0.18)] focus-within:border-slate-600 focus-within:shadow-[0_22px_42px_rgba(2,6,23,0.44),0_0_0_1px_rgba(148,163,184,0.2)] sm:px-7 sm:py-6";
  ...
  if (!showTeamBox) {
    return (
      <section className={compactSummaryCardClass}>
        ...
        <div className="relative z-10 flex min-h-[190px] flex-col items-center justify-center gap-5 text-center sm:min-h-[210px]">
  ...
  return (
    <section className={summaryCardClass}>
      ...
      <div className="relative z-10 grid h-full items-stretch gap-6 md:grid-cols-3 md:gap-8 md:divide-x md:divide-slate-700">
