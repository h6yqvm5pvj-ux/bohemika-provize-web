  ...
  return (
    <section className={goalCardClass}>
      ...
      <div className="relative flex flex-col gap-4">
            ...
            <div className="flex flex-col items-end gap-2 sm:gap-3">
              ...
              <div className="flex flex-wrap sm:flex-nowrap justify-end gap-2">
                <button
                  ...
                  className="rounded-full border border-emerald-300/40 bg-emerald-500/10 px-4 py-2 text-xs font-semibold text-emerald-50 hover:bg-emerald-500/20 transition disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                >
                ...
                <button
                  ...
                  className="rounded-full border border-white/25 px-4 py-2 text-xs font-semibold text-white/90 hover:bg-white/10 transition whitespace-nowrap"
                >
                  Upravit cíl
                </button>
              </div>
        ...
        {hasGoal ? (
          <div className="rounded-2xl border border-white/12 bg-white/[0.04] p-3 sm:p-4">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <p className="text-xs text-slate-300">
                {remainingImmediate > 0 ? (
                  <>
                    Do cíle chybí{" "}
                    <span className="font-semibold text-white">{formatMoney(remainingImmediate)}</span>{" "}
                    okamžité provize.
                  </>
                ) : (
                  <span className="font-semibold text-emerald-200">Cíl je splněný.</span>
                )}
              </p>
              {plan ? (
                <button
                  ...
                  className="rounded-full border border-white/20 px-3 py-1.5 text-[11px] font-semibold text-slate-200 hover:bg-white/10 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Přegenerovat
                </button>
              ) : null}
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="pt-1">
                  <button
                    ...
                    className="rounded-full border border-white/20 px-3 py-1.5 text-[11px] font-semibold text-slate-200 hover:bg-white/10 transition"
                  >
                    Skrýt náhodný plán
                  </button>
                </div>
