    ...
    <section className={goalCardClass}>
      {editOpen && (
        <div className="absolute inset-0 z-30 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-sm rounded-2xl border border-slate-900 bg-white p-5 shadow-[0_24px_60px_rgba(0,0,0,0.35)]">
            ...
            <div className="mt-3 space-y-2">
              <input
                ...
                className="w-full rounded-xl border border-slate-900 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-slate-800 focus:ring-2 focus:ring-slate-800/20"
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                ...
                className="rounded-xl border border-slate-900 bg-slate-100 px-3 py-1.5 text-xs text-slate-700 transition hover:bg-white"
                disabled={saving}
              >
                Zrušit
              </button>
      ...
      <div className="relative flex flex-col gap-4">
        ...
        {hasGoal ? (
          <div className="rounded-2xl border border-slate-900 bg-white p-3 sm:p-4">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              {plan ? (
                <button
                  ...
                  className="rounded-full border border-slate-900 bg-slate-100 px-3 py-1.5 text-[11px] font-semibold text-slate-700 transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Přegenerovat
                </button>
              ) : null}
            ...
            {plan && plan.items.length > 0 ? (
              <div className="mt-3 space-y-2">
                {plan.items.map((item, idx) => (
                  <div
                    key={item.id}
                    className="rounded-xl border border-slate-900 bg-slate-50 px-3 py-2"
                  >
                ...
                <div className="pt-1">
                  <button
                    ...
                    className="rounded-full border border-slate-900 bg-slate-100 px-3 py-1.5 text-[11px] font-semibold text-slate-700 transition hover:bg-white"
                  >
                    Skrýt náhodný plán
                  </button>
                </div>
