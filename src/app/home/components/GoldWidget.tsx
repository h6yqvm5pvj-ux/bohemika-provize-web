...
export function GoldWidget({
  ...
  const goldCardClass = isLiteUI
    ? "relative w-full overflow-hidden rounded-[28px] border border-slate-900 bg-white px-4 py-3 sm:px-5 sm:py-3"
    : "relative w-full overflow-hidden rounded-[28px] border border-slate-900 bg-white px-4 py-3 shadow-[0_12px_28px_rgba(15,23,42,0.1)] sm:px-5 sm:py-3";
