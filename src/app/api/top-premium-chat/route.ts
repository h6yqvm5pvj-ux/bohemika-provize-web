...
const WEBSITE_FEATURES: WebsiteFeature[] = [
  ...
  {
    id: "pracovni-neschopenka",
    title: "Pracovní neschopnost",
    path: "/pomucky/pracovni-neschopenka",
    summary: "Kalkulačka pro nastavení pojistné částky pracovní neschopnosti.",
    keywords: ["pracovni neschopnost", "neschopenka", "pn", "pojistna castka"],
  },
  {
    id: "invalidita",
    title: "Invalidita",
    path: "/pomucky/invalidita",
    summary: "Kalkulačka nastavení částky pro invaliditu 1., 2. a 3. stupně.",
    keywords: ["invalidita", "1. stupen", "2. stupen", "3. stupen"],
  },
  {
