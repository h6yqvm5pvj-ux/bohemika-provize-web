...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  {
    key: "srovnavac-odpovednosti-obcana",
    category: "Pojištění majetku",
    title: "Srovnávač odpovědnosti občana",
    description: "Srovnání občanské odpovědnosti: běžný život, sport, zvířata, nemovitosti, nájem a spolupojištěné osoby.",
