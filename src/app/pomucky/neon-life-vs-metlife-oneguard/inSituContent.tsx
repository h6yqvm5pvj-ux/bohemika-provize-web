...
export const IN_SITU_TITLE = "Co znamená premaligní a in situ?";
export const IN_SITU_DESCRIPTION = "Pojmy označují časné změny buněk před vznikem invazivního nádoru, nejde ale o totožné nálezy.";
export const IN_SITU_CONTENT = (
<div className="space-y-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2 text-xs font-black text-slate-800 sm:text-sm">
              ...
              <ArrowRight data-report-text="→" className="h-4 w-4 text-slate-400" aria-hidden="true" />
