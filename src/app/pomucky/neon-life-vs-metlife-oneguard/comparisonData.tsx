...
const ROW_CONTENT: RowContent[] = [
  {
    id: "uraz-neurazovy-dej",
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-violet-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-violet-700">
    ...
    neonLife: (
      <article className={styles.valueCard} data-tone="positive">
        ...
        <h3 className="mt-3 text-base font-semibold leading-5 text-emerald-950">
    ...
    oneGuard: (
      <article className={styles.valueCard} data-tone="caution">
        ...
        <h3 className="mt-3 text-base font-semibold leading-5 text-rose-950">
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-amber-800">
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-sky-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-sky-800">
          <Activity className="h-3.5 w-3.5" aria-hidden="true" />
          Invalidita
        </span>
        <h2 className="mt-3 text-lg font-semibold leading-tight text-slate-950">
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-indigo-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-indigo-800">
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-cyan-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-cyan-800">
        ...
        <div className="mt-4 rounded-xl border border-emerald-200 bg-white/80 p-3">
          ...
          <div className="mt-3 grid grid-cols-3 gap-2 text-center">
            {["1.", "2.", "3."].map((degree) => (
              ...
              >
                <CheckCircle2 className="mx-auto h-4 w-4 text-emerald-600" aria-hidden="true" />
                <span className="mt-1 block text-xs font-semibold text-emerald-950">
                  {degree} stupeň
                </span>
              </div>
            ))}
        ...
        <div className="mt-4 rounded-xl border border-rose-200 bg-white/85 p-3">
          ...
          <div className="mt-3 grid grid-cols-3 gap-2 text-center">
            {["1.", "2."].map((degree) => (
              ...
              >
                <CircleX className="mx-auto h-4 w-4 text-rose-600" aria-hidden="true" />
                <span className="mt-1 block text-xs font-semibold text-rose-950">
                  {degree} stupeň
                </span>
              </div>
            ))}
  ...
  },
  {
    ...
    neonLife: (
      <article className={styles.valueCard} data-tone="positive">
        ...
        <div className="mt-4 rounded-xl border border-violet-200 bg-violet-50 p-3">
          <div className="flex gap-2 text-sm font-semibold leading-5 text-violet-950">
            ...
            <div>
              ...
              <div className="mt-2 flex flex-wrap gap-x-3 gap-y-1">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="font-semibold text-violet-700 underline decoration-violet-300 underline-offset-2 hover:text-violet-950"
                >
                  § 38, § 40 a § 42 zákona
                </a>
                <a
    ...
    oneGuard: (
      <article className={styles.valueCard} data-tone="info">
        ...
        <h3 className="mt-3 text-base font-semibold leading-5 text-sky-950">
          Co je nutné doložit
        </h3>
        <div className="mt-4 space-y-2">
          {[
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-fuchsia-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-fuchsia-800">
          <Stethoscope className="h-3.5 w-3.5" aria-hidden="true" />
          Závažná onemocnění
        </span>
        <h2 className="mt-3 text-lg font-semibold leading-tight text-slate-950">
        ...
        <section className="mt-4 rounded-xl border border-rose-200 bg-rose-50/90 p-3">
          ...
          <div className="mt-3 flex gap-2 rounded-lg border border-emerald-200 bg-white/90 p-3 text-sm font-semibold leading-5 text-emerald-950">
            ...
            <span>
              ...
              <strong className="font-semibold"> Karcinom in situ</strong>, které tuto
              diagnózu zahrnuje.
            </span>
          </div>
        </section>
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-pink-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-pink-800">
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-blue-800">
      ...
      <article className={styles.valueCard} data-tone="caution">
        ...
        <section className="mt-4 rounded-xl border border-rose-200 bg-white/80 p-3">
          ...
          <p className="mt-2 text-sm font-semibold leading-5 text-rose-950/85">
            ...
            <mark className="mx-1 rounded bg-rose-200 px-1 font-semibold text-rose-950">
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-violet-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-violet-800">
          <Stethoscope className="h-3.5 w-3.5" aria-hidden="true" />
        ...
        <ul className="mt-3 space-y-2 text-sm font-semibold leading-5 text-rose-950/85">
          <li className="flex gap-2 rounded-lg border border-rose-200 bg-white/80 p-2.5">
            ...
            <span>
              ...
              <mark className="ml-1 rounded bg-rose-200 px-1 font-semibold text-rose-950">
  ...
  },
  {
    ...
    topic: (
      <div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-orange-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-orange-800">
          <Activity className="h-3.5 w-3.5" aria-hidden="true" />
          Úrazové pojištění
        </span>
        <h2 className="mt-3 flex items-center gap-2 text-lg font-semibold leading-tight text-slate-950">
  ...
  },
  {
    ...
    oneGuard: (
      <article className={styles.valueCard} data-tone="info">
        ...
        <h3 className="mt-3 text-base font-semibold leading-5 text-indigo-950">
          Podmínkou je chirurgická léčba
        </h3>
          ...
          <div className="flex gap-2 text-sm font-semibold leading-5 text-amber-950">
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-2 inline-flex text-xs font-semibold text-amber-800 underline decoration-amber-400 underline-offset-2 hover:text-amber-950"
              >
...
const GROUP_BY_ID: Record<string, string> = {
  "uraz-neurazovy-dej": "accident",
  "obecne-vyluky": "general",
  "invalidita-cekaci-doba": "disability",
  "snizena-sobestacnost": "disability",
  "invalidita-zavislost-dite": "family",
  "invalidita-zavislost-dite-povinnosti": "family",
  "zavazna-onemocneni": "illness",
  "zavazna-zenska-onemocneni": "illness",
  "zavazna-muzska-onemocneni": "illness",
  "asistovana-reprodukce": "family",
  "pracovni-neschopnost-tehotenstvi": "income",
  "pracovni-neschopnost-soubeh-plneni": "income",
  "pracovni-neschopnost-zanik-vycerpanim-limitu": "income",
  "pracovni-neschopnost-diagnozy-m": "income",
  "hospitalizace-dite-vrozene-vady": "family",
  "trvale-nasledky-urazu-definice": "accident",
  "trvale-nasledky-progresivni-plneni": "accident",
  "horni-koncetiny-vyluka": "accident",
  "horni-koncetiny-karpalni-tunel": "accident",
  "horni-koncetiny-tenisovy-loket": "accident",
};
...
function childText(node: ReactNode, tag: string) {
  if (!isValidElement<{ children?: ReactNode }>(node)) return "";
  const child = Children.toArray(node.props.children).find(child => isValidElement(child) && child.type === tag);
  return nodeText(child).replace(/\s+/g, " ").trim();
}

function productSummary(node: ReactNode) {
  const tone = isValidElement<{ "data-tone"?: string }>(node) ? node.props["data-tone"] ?? "neutral" : "neutral";
  return { title: childText(node, "h3") || "Není v nabídce", status: childText(node, "span"), tone };
}
...
export type ComparisonRow = RowContent & {
  ...
  title: string;
  searchText: string;
  neonSummary: ReturnType<typeof productSummary>;
  oneGuardSummary: ReturnType<typeof productSummary>;
};

// These nodes cross the server/client boundary and render alongside client labels.
function keyedContent(node: ReactNode, key: string): ReactNode {
...
export const COMPARISON_ROWS: ComparisonRow[] = ROW_CONTENT.map(row => ({
  ...
  group: GROUP_BY_ID[row.id],
  title: childText(row.topic, "h2"),
  searchText: [row.topic, row.neonLife, row.oneGuard].map(nodeText).join(" "),
  neonSummary: productSummary(row.neonLife),
  oneGuardSummary: productSummary(row.oneGuard),
}));
