...
function InfoCard({
  ...
  return (
    <section
      className={`relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-4 shadow-[0_10px_24px_rgba(15,23,42,0.06)] sm:p-5 ${className}`}
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-sky-300 via-cyan-300 to-emerald-300" />
...
function MetricRing({
  ...
  return (
    <div className="flex flex-col items-center gap-1 rounded-2xl border border-slate-200 bg-slate-50/40 px-3 py-3">
      ...
      <div className="mx-auto w-full max-w-6xl space-y-4 pb-8">
        ...
        {searchActivated && (loading ? (
          ...
          <div className="space-y-4">
            <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-4 shadow-[0_14px_34px_rgba(15,23,42,0.08)] sm:p-5">
              <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-slate-900 via-sky-400 to-emerald-400" />
              <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                <div className="space-y-3">
                  ...
                  <div>
                    <h2 className="text-4xl leading-tight font-semibold text-slate-900 tracking-tight sm:text-5xl">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-full border border-slate-300 bg-white px-2.5 py-1 text-[11px] font-semibold text-slate-700 transition hover:border-slate-900 hover:text-slate-900"
                    >
                    ...
                    <Link
                      href={valuationHref}
                      className="inline-flex items-center gap-1 rounded-full border border-slate-900 bg-slate-900 px-2.5 py-1 text-[11px] font-semibold text-white transition hover:bg-black"
                    >
                ...
                <div className="grid grid-cols-2 gap-3 min-w-[240px]">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50/40 px-3 py-3">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50/40 px-3 py-3 col-span-2">
                    <div className="inline-flex items-center gap-1 text-[10px] uppercase tracking-widest text-slate-500">
                      <CalendarDays className="h-3.5 w-3.5" />
                      1. registrace / ČR
                    </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              <InfoCard icon={<Weight className="h-4 w-4" />} title="Hmotnosti a Závěs">
                <div className="rounded-2xl border border-slate-200 bg-slate-50/40 p-3 space-y-2.5">
                  ...
                  <div className="h-2 rounded-full bg-white overflow-hidden ring-1 ring-slate-200">
                    <div
            ...
            <section className="rounded-2xl border border-slate-200 bg-slate-50/40">
