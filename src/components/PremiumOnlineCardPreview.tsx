...
export function PremiumOnlineCardPreview({
  ...
  const identityBlock = (
    <div className={`${fullWidthLayout ? "space-y-2" : "space-y-2 pt-1"} vizitka-anim-up [animation-delay:140ms]`}>
      {fullWidthLayout ? (
        <p className="inline-flex items-center gap-2 rounded-full border border-violet-300/35 bg-white/[0.06] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-violet-100">
          <UserRound className="h-3.5 w-3.5 text-fuchsia-300" />
          Profil poradce
        </p>
      ) : null}
  ...
  const bioSection = (
    <section
      className={`border-t pt-5 sm:pt-6 vizitka-anim-up [animation-delay:360ms] ${
    ...
    >
      ...
      {editable ? (
        <div className={`${editableFieldFrameClass} mt-3`}>
          ...
          <textarea
            ...
            className={`mt-1 min-h-[130px] w-full resize-y bg-transparent text-sm leading-relaxed outline-none sm:text-base ${
    ...
    >
      {fullWidthLayout ? (
        <>
          ...
          <div className="pointer-events-none absolute inset-[1px] rounded-[35px] border border-white/7" />
        </>
      ) : (
        <>
	      ...
	      <div className={`relative z-10 ${fullWidthLayout ? "space-y-7" : "space-y-6 sm:space-y-8"}`}>
	        {editable ? (
	          <div
            className={`mb-4 ${
              fullWidthLayout
          ...
          >
	            <div className="flex items-center gap-2 border-b border-[#1e293b] bg-[linear-gradient(90deg,#0b1220_0%,#0a1a3f_50%,#0a3356_100%)] px-4 py-2 vizitka-anim-up [animation-delay:20ms]">
	        ...
	        {editable ? (
	          <div
	            className={`inline-flex w-fit max-w-full items-center gap-2 rounded-full border px-3 py-1.5 text-[11px] font-semibold vizitka-anim-up [animation-delay:50ms] ${
	              fullWidthLayout
        ...
        {fullWidthLayout ? (
          <header className="pb-6 pt-1 sm:pb-7 vizitka-anim-up [animation-delay:80ms]">
            <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-start">
              <div className="order-2 space-y-6 text-left lg:order-1 lg:pt-2">
                {identityBlock}
                {bioSection}
              </div>
              <div className="order-1 ml-auto flex flex-col items-center gap-4 text-center lg:order-2 lg:-mt-20 xl:-mt-24 vizitka-anim-right [animation-delay:260ms]">
                <div className="relative">
                  <Image
                    ...
                    width={420}
                    height={96}
                    className="h-[320px] w-auto object-contain object-top opacity-95 sm:h-[430px] vizitka-float-soft"
                  />
                  <div className="pointer-events-none absolute left-1/2 top-[67.8%] hidden w-[115vw] -translate-x-1/2 items-center gap-6 lg:flex xl:top-[68.2%]">
                ...
                {meetingCta ? (
                  <button
                    ...
                    className="-mt-10 inline-flex min-w-[260px] items-center justify-center gap-2 rounded-[20px] border border-violet-300/20 bg-[linear-gradient(120deg,#7c3aed_0%,#a855f7_55%,#c084fc_100%)] px-7 py-3 text-lg font-bold text-white shadow-[0_22px_44px_rgba(124,58,237,0.4)] transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-70 sm:-mt-12 vizitka-cta-glow"
                  >
