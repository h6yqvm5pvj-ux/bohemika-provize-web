...
export const ONLINE_CARD_COPY = {
  cs: {
    ...
    public: {
      ...
      scheduleDescription: "Stačí jméno a telefon nebo e-mail. Zprávu můžete vynechat.",
      closeForm: "Zavřít formulář",
      submitted: "Žádost byla odeslána. Brzy se ti ozveme.",
      onlineCardTitle: "Online vizitka Bohemika",
    },
    meeting: {
      preferredContact: "Jak se vám mám ozvat?",
      byPhone: "Telefonem",
      byEmail: "E-mailem",
      emailPlaceholder: "jan@firma.cz",
      nameError: "Vyplňte prosím jméno a příjmení.",
      phoneError: "Vyplňte prosím platné telefonní číslo.",
      emailError: "Vyplňte prosím platný e-mail.",
      topics: [
        "Pojištění vozidel",
        "Pojištění majetku",
