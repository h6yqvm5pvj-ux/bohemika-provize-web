...
export const ONLINE_CARD_COPY = {
  cs: {
    ...
    advisor: {
      ...
      partnersKicker: "Partnerské pojišťovny",
      partnersTitle: "Spolupracujeme s předními značkami",
      partnersLead: "Výběr řešení stavíme podle klienta, ne podle jedné pojišťovny.",
    },
  },
  en: {
    preview: {
