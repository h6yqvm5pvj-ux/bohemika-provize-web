...
2. Je-li potřeba ověřit e-mail, dokončit ověření skutečné adresy. Administrátorskou akci „ověřit e-mail“ použít pouze po ověření jeho vlastnictví.
3. Uživatel otevře `https://bohemka.app/ucet/zabezpeceni`, přihlásí se svým heslem a nastaví TOTP ve své autentizační aplikaci. Stránka používá oddělenou relaci jen v paměti, nečte obchodní data a nevytváří aplikační cookie.
