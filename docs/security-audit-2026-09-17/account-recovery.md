...
2. Před vytvořením TOTP klíče i před zapnutím faktoru se vždy obnoví aktuální stav ověření e-mailu z Firebase. Již ověřená adresa zůstává platná. Neověřenému účtu stránka vyžádá Firebase odkaz doručený přes Resend; uživatel ho otevře ve své schránce, vrátí se a klikne na „E-mail je ověřený, pokračovat“. Odesílací endpoint přijme čerstvé přihlášení heslem i bez TOTP, kontroluje deaktivaci, blokace a revokace a neposkytuje aplikační relaci ani obchodní data. Administrace umí odkaz znovu poslat, příznak ověření ale ručně nenastavuje.
